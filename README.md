...
| 文件 | 标题 | 主题 | 日期 |
| --- | --- | --- | --- |
| `echo-checkup.html` | 医生看我一眼，就知道我哪里不好 | 体检被医生一眼看穿的年纪 × 二十岁走进杭电校门的浑身是劲；反用「来日方长」说初心不忘 | 07·08 |
...
- **2026·07·08** — 新增 `echo-checkup.html`《医生看我一眼，就知道我哪里不好》（个人记述）——体检时医生一眼看穿颈椎/睡眠/肝，与二十岁走进杭电校门那天浑身是劲的记忆对照；反用成语「来日方长」为「来日不方长」，落点在「身体的账单我认，可初心不忘还想护着」。已跑 `tools/` 三脚本。同步 explore / rss / 互链（echo-hangzhou ⇄ echo-checkup、→ 身体总是先知道）。
